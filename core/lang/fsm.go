...
type Transition struct {
  // Implicit Source from FMT's key
  NextState State
  TokenType TokenType
}
...
var FSM = map[State]([]Transition){
  STATE_STMT_START: []Transition{
    {STATE_CREATE_START, TOKEN_KW_CREATE},
  },

  STATE_CREATE_START: []Transition{
    {STATE_CREATE_DIM_START, TOKEN_KW_DIMENSION},
  },

  STATE_CREATE_DIM_START: []Transition{
    {STATE_CREATE_DIM_IDENTIFIER, TOKEN_IDENTIFIER},
  },

  STATE_CREATE_DIM_IDENTIFIER: []Transition{
    {STATE_LEVELS_START, TOKEN_PAR_OPEN},
  },

  STATE_LEVELS_START: []Transition{
    {STATE_LEVEL_IDENTIFIER, TOKEN_IDENTIFIER},
  },

  STATE_LEVEL_IDENTIFIER: []Transition{
    {STATE_ATTRIBUTES_START, TOKEN_PAR_OPEN},
  },

  STATE_ATTRIBUTES_START: []Transition{
    {STATE_ATTRIBUTE_IDENTIFIER, TOKEN_IDENTIFIER},
  },

  STATE_ATTRIBUTE_IDENTIFIER: []Transition{
    {STATE_ATTRIBUTE_TYPE, TOKEN_KW_STRING},
    {STATE_ATTRIBUTE_TYPE, TOKEN_KW_INTEGER},
  },

  STATE_ATTRIBUTE_TYPE: []Transition{
    {STATE_ATTRIBUTE_DEFAULT, TOKEN_KW_DEFAULT},
    {STATE_ATTRIBUTES_NEXT, TOKEN_COMA},
    {STATE_ATTRIBUTES_END, TOKEN_PAR_CLOSE},
  },
  ...
  STATE_ATTRIBUTES_END: []Transition{
    {STATE_LEVELS_NEXT, TOKEN_COMA},
    {STATE_LEVELS_END, TOKEN_PAR_CLOSE},
  },
